var Thoth = function () {
  ...
  var js = {
    ...
    yui: {
      anim     : 'http://yui.yahooapis.com/2.5.2/build/animation/animation-min.js',
      conn_json: 'http://yui.yahooapis.com/combo?2.5.2/build/connection/connection-min.js&2.5.2/build/json/json-min.js'
    }
  };
  ...
  return {
    ...
    init: function (admin, formToken) {
      ...
      if (admin) {
        ...
        // input elements.
        if (yud.getElementsByClassName('tags-input', 'input').length) {
          LazyLoad.loadOnce([js.yui.conn_json, js.thoth.tagcomplete]);
        }

        // Load the Comments module if this page contains comments.
        if (yud.get('comments')) {
          LazyLoad.loadOnce([js.yui.conn_json, js.thoth.comments]);
        }
      }
    },
